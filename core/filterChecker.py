...
def filterChecker(url, params, headers, GET, delay, occurences, timeout, encoding, encoding_fallback=False):
    ...
    for environment in environments:
        if environment:
            efficiencies = checker(
                url, params, headers, GET, delay, environment, positions, timeout, encoding, encoding_fallback)
